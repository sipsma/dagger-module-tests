...
func (r *RootMod) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "RootMod":
		...
		case "ContainerEcho":
			...
			return (*RootMod).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent RootMod
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*RootMod).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("RootMod").
					WithFunction(
