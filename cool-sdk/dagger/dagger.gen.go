...
func (r *CoolSdk) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "CoolSdk":
		...
		case "ContainerEcho":
			...
			return (*CoolSdk).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent CoolSdk
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*CoolSdk).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("CoolSdk").
					WithFunction(
